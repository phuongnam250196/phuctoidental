            ...
            <div class="container">
                ...
                <nav class="menu_header">
                    <ul id="menu-main-menu" class="menu">
                        ...
                        <li id="menu-item-516" class="menu-item @if(Request::is('account') || Request::is('account/*')) current_page_ancestor @endif"><a href="{{url('/account')}}" title="Tài khoản">Tài khoản</a></li>
                    </ul>
                </nav>
            </div>
        </div>
